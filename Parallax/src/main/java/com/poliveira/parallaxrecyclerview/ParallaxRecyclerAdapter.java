...
public abstract class ParallaxRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void translateHeader(float of) {
        ...
        if (mParallaxScroll != null) {
            final RecyclerView.ViewHolder holder = mRecyclerView.getRecyclerView().findViewHolderForAdapterPosition(0);
            float left;
            if (holder != null) {
     ...
     */
    public void setParallaxHeader(View header, final SuperRecyclerView view) {
        mRecyclerView = view;
        ...
        view.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (mHeader != null) {
                    translateHeader(mRecyclerView.getRecyclerView().getLayoutManager().getChildAt(0) == mHeader ?
                            mRecyclerView.getRecyclerView().computeVerticalScrollOffset() : mHeader.getHeight());
